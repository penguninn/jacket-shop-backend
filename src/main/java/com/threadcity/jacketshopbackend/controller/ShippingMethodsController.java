...
public class ShippingMethodsController {
        ...
        @PostMapping
        public ApiResponse<?> createShippingMethod(@Valid @RequestBody ShippingMethodsRequest request) {
        ...
        public ApiResponse<?> updateShippingMethod(
                        ...
                        @Valid @RequestBody ShippingMethodsRequest request) {
        ...
        public ApiResponse<?> updateStatus(
                ...
                ShippingMethodsResponse response = shippingMethodService.updateStatus(request, id);
        ...
        public ApiResponse<?> bulkUpdateStatus(@Valid @RequestBody BulkStatusRequest request) {
                ...
                List<ShippingMethodsResponse> response = shippingMethodService.bulkUpdateShippingMethodsStatus(request);
        ...
        public ApiResponse<?> bulkDelete(@Valid @RequestBody BulkDeleteRequest request) {
                ...
                shippingMethodService.bulkDeleteShippingMethods(request);
